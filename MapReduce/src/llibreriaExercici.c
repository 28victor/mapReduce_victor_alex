...
void compteparaules()
{
    ...
    remove("./fitxers/ResultatParaules.txt");
    ...
    // llegirFitxerSencer("ResultatParaules");
    // printf("\n");
...
void contadorParaula(char titol[], char rutaDup[])
{
    ...
    fAuxP = fopen("./fitxers/ResultatParaules.txt", "at");
...
{
    // Borrem el "Resultat.txt" anterior per no tenir problemes.
    remove("./fitxers/ResultatCaractes.txt");
    remove("./fitxers/noms.txt");
    remove("./fitxers/dup.txt");
    ...
    // Executem un procediment que llegira el fitxer "Resultat.txt" complet.
    // llegirFitxerSencer("ResultatCaracters");
    printf("\n");
...
void contadorCaracter(char nomC, char rutaDupliC[])
{
    ...
    fAuxC = fopen("./fitxers/ResultatCaracters.txt", "at");
